...
Para la realizacion de ese ejercicio hemos entado en la [URL facilitada en el enunciado](https://www.bitaddress.org/).

![Portal de bitaddress.org](./imagen-1.png)


Posteriormente de hacer que corriera el javascrip ha permitido meter las llaves facilitadas dentro del generador de direcciones. Se adjunta pantallazo del mismo resultante

![Introduccion de claves en bitaddress.org](./imagen-2.png)


En este caso, la clave combinada es:

 **`5KMQDeUAevpdQtZTX9Q4W6csHRbq59JMHDpeKHVCRzni5pd8fuz`**
